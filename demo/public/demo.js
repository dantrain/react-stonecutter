...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactRadioGroup = __webpack_require__(192);
	...
	exports.default = _react2.default.createClass({
	  ...
	  generateData: function generateData() {
	    return (0, _lodash2.default)(alphabet).slice(0, this.props.minItems + Math.floor(Math.random() * (26 - this.props.minItems))).sort();
	  },
	  render: function render() {
	    ...
	    var gridProps = _objectWithoutProperties(_state, ['data']);

	    var items = data.map(function (letter) {
	      var content = ipsum.slice(0, (letter.charCodeAt(0) % 3 + 1) * 50);
	        ...
	        _react2.default.createElement(
	          _reactRadioGroup2.default,
	          {
	            ...
	            onChange: function onChange(value) {
	              return _this.setState({ useCSS: value === 'css' });
	            }
	          },
	          function (Radio) {
	            return _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'label',
	                null,
	                _react2.default.createElement(Radio, { value: 'spring' }),
	                'React Motion'
	              ),
	              _react2.default.createElement(
	                'label',
	                null,
	                _react2.default.createElement(Radio, { value: 'css' }),
	                'CSS Transitions'
	              )
	            );
	          }
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', {
	            ...
	            onChange: function onChange(ev) {
	              return _this.setState({ responsive: ev.target.checked });
	            }
	          }),
	          'Responsive'
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var sampleSize = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactBrickwork = __webpack_require__(169);
	...
	exports.default = _react2.default.createClass({
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    if (!(0, _lodash2.default)(nextProps, this.props, function (a, b, key) {
	      if (key === 'children') return true;
	    })) {
	      this.createGrid(nextProps);
	    }
	  },
	  createGrid: function createGrid(_ref) {
	    var useCSS = _ref.useCSS;
	    var measured = _ref.measured;
	    var responsive = _ref.responsive;

	    var Grid = useCSS ? _reactBrickwork.CSSGrid : _reactBrickwork.SpringGrid;

	    if (measured) {
	      Grid = (0, _reactBrickwork.measureItems)(Grid);
	    }

	    if (responsive) {
	      Grid = (0, _reactBrickwork.makeResponsive)(Grid, {
	        maxWidth: 1200,
	        minPadding: 100
	      });
	    }
	  ...
	  render: function render() {
	    ...
	    var useCSS = _props.useCSS;
	    var responsive = _props.responsive;
	    var layout = _props.layout;
	    var enterExitStyle = _props.enterExitStyle;
	    var duration = _props.duration;
	    var stiffness = _props.stiffness;
	    var damping = _props.damping;
	    var Grid = this.state.Grid;


	    var gridLayout = _reactBrickwork2.default.layout[layout];
	    var gridEnterExitStyle = _reactBrickwork2.default.enterExitStyle[enterExitStyle];
	    ...
	    return _react2.default.createElement(
	      Grid,
	      {
	        ...
	        springConfig: !useCSS && stiffness && damping ? { stiffness: stiffness, damping: damping, precision: 0.1 } : null
	      },
	      children
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if (( false ? 'undefined' : _typeof(exports)) === 'object' && ( false ? 'undefined' : _typeof(module)) === 'object') module.exports = factory(__webpack_require__(1), __webpack_require__(170), __webpack_require__(173), __webpack_require__(174), __webpack_require__(188), __webpack_require__(189));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(170), __webpack_require__(173), __webpack_require__(174), __webpack_require__(188), __webpack_require__(189)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["reactBrickwork"] = factory(require("react"), require("react-addons-transition-group"), require("lodash.isequal"), require("react-motion"), require("enquire.js"), require("lodash.partition"));else root["reactBrickwork"] = factory(root["react"], root["react-addons-transition-group"], root["lodash.isequal"], root["react-motion"], root["enquire.js"], root["lodash.partition"]);
	})(undefined, function (__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_16__) {
		return (/******/function (modules) {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _pinterest = __webpack_require__(17);
				...
				var _foldDown = __webpack_require__(18);

				var foldDown = _interopRequireWildcard(_foldDown);

				var _fromCenter = __webpack_require__(19);

				var fromCenter = _interopRequireWildcard(_fromCenter);

				var _fromLeftToRight = __webpack_require__(20);

				var fromLeftToRight = _interopRequireWildcard(_fromLeftToRight);

				var _fromTop = __webpack_require__(21);

				var fromTop = _interopRequireWildcard(_fromTop);

				var _fromTopToBottom = __webpack_require__(22);

				var fromTopToBottom = _interopRequireWildcard(_fromTopToBottom);

				var _newspaper = __webpack_require__(23);
				...
				var _skew = __webpack_require__(24);
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _transformHelpers = __webpack_require__(7);

				var _CSSGridItem = __webpack_require__(8);
				...
				exports.default = _react2.default.createClass({
					...
					doLayout: function doLayout(props) {
						...
						this.setState({ gridWidth: gridWidth, gridHeight: gridHeight, positions: positions });
					},
					render: function render() {
						var _this = this;
						...
						var rest = _objectWithoutProperties(_props, ['component', 'style', 'children', 'duration', 'easing', 'units']);
						...
						var lengthUnit = units && units.length || 'px';
						...
						var wrappedItems = items.map(function (item, i) {
							return _react2.default.createElement(_CSSGridItem2.default, _extends({
								key: item.key,
			...
			/***/function (module, exports) {
				...
				var defaultUnits = exports.defaultUnits = {
					length: 'px',
					angle: 'deg'
				};
			...
			/***/function (module, exports, __webpack_require__) {
				...
				exports.default = _react2.default.createClass({
					...
					componentWillEnter: function componentWillEnter(done) {
						...
						this.setState({
							style: _extends({}, this.state.style, (0, _transformHelpers.positionToProperties)(position), {
								zIndex: 1
							}, gridProps.enter(this.props, gridProps, gridState))
						});

						this.enterTimeout = setTimeout(function () {
							_this.setEndStyle(_this.props, 1);
							done();
						}, 17);
					},
						...
						this.leaveTimeout = setTimeout(function () {
							_this2.setState({
								style: _extends({}, _this2.state.style, {
									zIndex: 0
								}, gridProps.exit(_this2.props, gridProps, gridState))
							});

							_this2.leaveTimeout = setTimeout(done, _this2.props.duration);
						}, 0);
					},
					...
					render: function render() {
						...
						var transform = (0, _transformHelpers.buildTransform)(this.state.style, perspective, _extends({}, _transformHelpers.defaultUnits, units));
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _stripStyle = __webpack_require__(12);
				...
				exports.default = _react2.default.createClass({
					...
					propTypes: {
						...
						gutterWidth: _react2.default.PropTypes.number,
						gutterHeight: _react2.default.PropTypes.number,
						springConfig: _react2.default.PropTypes.object,
						component: _react2.default.PropTypes.string,
						layout: _react2.default.PropTypes.func,
						enter: _react2.default.PropTypes.func,
						entered: _react2.default.PropTypes.func,
						...
						var styles = positions.map(function (position, i) {
							return _extends({}, items[i], {
								style: _extends({}, items[i].style, {
									zIndex: 2
								}, springify(_this.props.entered(items[i].data.element.props, _this.props, { gridWidth: gridWidth, gridHeight: gridHeight }), props.springConfig), springify((0, _transformHelpers.positionToProperties)(position), props.springConfig))
							});
						});
					...
					render: function render() {
						...
						var rest = _objectWithoutProperties(_props, ['component', 'style', 'perspective', 'units']);
						...
						return _react2.default.createElement(_reactMotion.TransitionMotion, {
							...
							return _react2.default.createElement(component, _extends({
								...
								var transform = (0, _transformHelpers.buildTransform)(config.style, perspective, _extends({}, _transformHelpers.defaultUnits, units));
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _enquire = __webpack_require__(14);
				...
				exports.default = function (Grid) {
					return _react2.default.createClass({
						...
						render: function render() {
							...
							return _react2.default.createElement('span', null, measuredElements.length && _react2.default.createElement(Grid, this.props, measuredElements), elementsToMeasure.length > 0 && _react2.default.createElement(component, {
								style: {
									width: 0,
									height: 0,
									padding: 0,
			...
			/***/function (module, exports) {
				...
				exports.default = function (items, props) {
					...
					var positions = items.map(function (itemProps) {
						...
						var height = Math.round(itemProps.itemRect.height);
			...
			/***/function (module, exports) {
				...
				var enter = exports.enter = function enter() {
					return { translateY: -500, opacity: 0 };
				};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Motion = __webpack_require__(175);

	exports.Motion = _interopRequire(_Motion);

	var _StaggeredMotion = __webpack_require__(182);

	exports.StaggeredMotion = _interopRequire(_StaggeredMotion);

	var _TransitionMotion = __webpack_require__(183);
	...
	var _reorderKeys = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapToZero = __webpack_require__(176);

	var _mapToZero2 = _interopRequireDefault(_mapToZero);

	var _stripStyle = __webpack_require__(177);

	var _stripStyle2 = _interopRequireDefault(_stripStyle);

	var _stepper3 = __webpack_require__(178);

	var _stepper4 = _interopRequireDefault(_stepper3);

	var _performanceNow = __webpack_require__(179);
	...
	var _shouldStopAnimation = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mergeDiff = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseEach = __webpack_require__(190),
	    baseIteratee = __webpack_require__(191);
